...
const latestHomepageArticles = articles.filter(isEligibleArticle).slice(0, 4);
...
<div class="home-brief-page">
<section class="home-brief-hero" aria-labelledby="home-brief-title">
  <div class="home-brief-hero__content">
    <p class="home-brief-eyebrow">FOUNDING BOARD PREPARATION · 2026</p>
    <h1 id="home-brief-title"><span>公民秩序主义</span><strong>北美非营利组织及首届董事会筹备</strong></h1>
    <p class="home-brief-hero__tagline">为和平政治转轨建立信任、能力与人才。</p>
    <p class="home-brief-hero__copy">公民秩序主义正在从政治判断与公共理论表达，进入长期组织建设阶段。当前重点是建立北美非营利组织、筹备首届董事会，并逐步形成能够被识别、建立信任、承担责任的政治承接能力。</p>
    <div class="home-brief-actions"><a class="home-brief-button home-brief-button--primary" href="/files/civic-orderism-founding-board-brief-2026.pdf" target="_blank" rel="noopener">阅读筹备文件</a><a class="home-brief-button home-brief-button--secondary" href="/preparation">了解董事会筹备</a><a class="home-brief-button home-brief-button--text" href="${organization.routes.participate}">参与筹备</a></div>
    <p class="home-brief-status">当前处于前期筹备阶段，非营利法人尚未完成注册，首届董事会尚未依法产生。</p>
  </div>
  <a class="home-brief-cover-card" href="/files/civic-orderism-founding-board-brief-2026.pdf" target="_blank" rel="noopener" aria-label="打开《公民秩序主义北美非营利组织及首届董事会筹备文件》PDF">
    <img src="/files/civic-orderism-founding-board-brief-2026-cover.png" alt="《公民秩序主义北美非营利组织及首届董事会筹备文件》封面" width="1191" height="1684">
    <span>OFFICIAL EDITION</span><strong>Version 1.0 · 2026</strong><small>Document ID · CO-2026-002</small>
  </a>
</section>

<section class="home-brief-section" id="why-organization">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">01 · ORGANIZATION</p><h2>为什么需要组织？</h2><p>和平政治转轨最终不能只依靠社会情绪、网络传播或者某一个人。新的政治力量必须成为一个可以被识别、可以沟通、能够履行承诺并承担责任的组织主体。</p></div>
  <div class="home-brief-triad"><article><span>01</span><h3>可以被识别</h3><p>明确谁代表组织，谁能够作出有效承诺。</p></article><article><span>02</span><h3>可以建立信任</h3><p>让沟通、承诺和责任具有连续性，而不是依赖个人关系。</p></article><article><span>03</span><h3>可以承担责任</h3><p>使未来政治沟通、治理协作与公共责任拥有现实主体。</p></article></div>
  <p class="home-brief-conclusion">只有组织，才能与组织建立稳定的政治信任。</p>
</section>

<section class="home-brief-section" id="political-capacity">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">02 · POLITICAL CAPACITY</p><h2>建立政治承接能力</h2><p>信任、能力与人才，共同构成和平政治转轨的承接基础。</p></div>
  <div class="home-brief-capacity-grid"><article><span>01</span><h3>信任</h3><strong>组织间政治信任</strong><p>对外建立旧政治秩序能够识别、沟通并逐渐建立信任的组织主体。</p></article><article><span>02</span><h3>能力</h3><strong>组织基础设施</strong><p>对内形成法律、财务、人员、治理、档案与责任体系。</p></article><article><span>03</span><h3>人才</h3><strong>公共治理人才</strong><p>面向未来识别、培养并检验能够承担公共责任的人。</p></article></div>
  <p class="home-brief-formula">信任 <span>×</span> 能力 <span>×</span> 人才，共同构成政治承接能力。</p>
</section>

<section class="home-brief-section home-brief-board" id="why-board">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">03 · FOUNDING BOARD</p><h2>为什么需要首届董事会？</h2></div>
  <blockquote>董事会存在的第一个意义，是证明这个组织不属于任何一个人。</blockquote>
  <p>董事会意味着公民秩序主义第一次把政治承诺、治理、监督、财务责任、风险管理与组织连续性转化为现实组织规则。</p>
  <div class="home-brief-section__footer"><strong>董事会不是形式要求，而是组织开始接受约束的制度起点。</strong><a href="/preparation/board">了解董事会筹备</a></div>
</section>

<section class="home-brief-section" id="organization-boundaries">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">04 · ORGANIZATIONAL BOUNDARIES</p><h2>建立什么样的组织？</h2></div>
  <div class="home-brief-boundaries"><div><h3>不是</h3><ol><li>革命组织</li><li>政治清算平台</li><li>地下政治组织</li><li>街头动员组织</li><li>个人政治工具</li><li>网络情绪共同体</li></ol></div><div><h3>希望成为</h3><ol><li>公开</li><li>合法</li><li>长期</li><li>制度化</li><li>具有公共责任</li><li>具有政治信誉</li></ol></div></div>
  <p class="home-brief-conclusion">和平政治转轨的长期组织准备：可以被信任、能够承担责任、具备长期承接能力。</p>
</section>

<section class="home-brief-section" id="long-term-cooperation">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">05 · COOPERATION</p><h2>与什么样的人建立长期联系？</h2><p>不要求完全认同公民秩序主义全部理论。共同程序原则与基本和平转轨方向，比理论完全一致更重要。</p></div>
  <ol class="home-brief-principles"><li><span>01</span>和平政治转轨</li><li><span>02</span>不革命、不清算</li><li><span>03</span>保持国家行政连续性</li><li><span>04</span>权力接受制度约束</li><li><span>05</span>组织逐渐摆脱个人化</li><li><span>06</span>程序优先于个人意志</li><li><span>07</span>能够与不同意见长期合作</li></ol>
  <div class="home-brief-section__footer"><strong>国家有秩序，人民有尊严；权力受约束，生活有保障，社会有预期。</strong><a href="${organization.routes.participate}">了解参与方式</a></div>
</section>

<section class="home-brief-section" id="development-path">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">06 · DEVELOPMENT PATH</p><h2>当前发展路径</h2><p>从理论形成走向可以被信任、能够承担责任的长期政治承接能力。</p></div>
  <ol class="home-brief-stages"><li><span>01</span><strong>理论形成</strong></li><li><span>02</span><strong>公共传播</strong></li><li class="is-current"><span>03</span><strong>组织建设</strong><small>CURRENT STAGE</small></li><li class="is-current"><span>04</span><strong>非营利法人</strong><small>CURRENT STAGE</small></li><li class="is-current"><span>05</span><strong>首届董事会</strong><small>CURRENT STAGE</small></li><li><span>06</span><strong>组织信用</strong></li><li><span>07</span><strong>长期政治承接能力</strong></li></ol>
</section>

<section class="home-brief-section home-brief-document" id="official-document">
  <div class="home-brief-document__cover"><img src="/files/civic-orderism-founding-board-brief-2026-cover.png" alt="" width="1191" height="1684" loading="lazy"></div>
  <div class="home-brief-document__content"><p class="home-brief-eyebrow">OFFICIAL EDITION</p><h2>阅读完整筹备文件</h2><h3>公民秩序主义<br>北美非营利组织及首届董事会筹备文件</h3><dl><div><dt>Version</dt><dd>1.0 · 2026</dd></div><div><dt>Document ID</dt><dd>CO-2026-002</dd></div></dl><p>本文件系统说明为什么需要组织、什么是政治承接能力、为什么需要首届董事会，以及公民秩序主义当前的组织发展路径。</p><a class="home-brief-button home-brief-button--document" href="/files/civic-orderism-founding-board-brief-2026.pdf" target="_blank" rel="noopener">打开正式文件</a></div>
</section>

<section class="home-brief-section" id="theory-and-research">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">07 · THEORY & RESEARCH</p><h2>理论与研究</h2><p>组织建设建立在持续的政治判断、现实分析与中国未来研究基础之上。</p></div>
  <div class="home-direction-grid">${homepageDirectionCards}</div>
  <div class="home-brief-latest"><div class="home-section-heading"><div><p class="resource-label">最新文章</p><h2>近期发布</h2></div><a href="/articles">查看全部文章</a></div><div class="recent-article-list">${latestHomepageRows}</div></div>
</section>

<section class="home-brief-section home-brief-foundation" id="introduction-manual-entry">
  <div><p class="home-brief-eyebrow">BASIC READING</p><h2>基础阅读</h2><p>第一次接触公民秩序主义，可从《公民秩序主义介绍手册》开始。</p></div><a href="/introduction-manual">阅读介绍手册</a>
</section>

<section class="home-brief-section home-brief-contact" id="contact">
  <div><p class="home-brief-eyebrow">CONTACT</p><h2>建立联系</h2><p>围绕首届董事会筹备、专业协作或长期组织建设建立联系。</p></div>
