...
const homepageDirectionCards = [
  ...
  },
  {
    label: "解析中共",
    href: "/china",
    description: "从党国结构与官僚系统出发，理解权力运行、治理失灵与制度压力。",
  },
  {
    label: "中国未来",
    href: "/china-future",
...
<section class="home-brief-hero" aria-labelledby="home-brief-title">
  <div class="home-brief-hero__content">
    ...
    <div class="home-brief-actions"><a class="home-brief-button home-brief-button--primary" href="/files/civic-orderism-founding-board-brief-2026.pdf" target="_blank" rel="noopener">阅读正式文件</a><a class="home-brief-button home-brief-button--secondary" href="${organization.routes.participate}">参与董事会筹备</a></div>
    <div class="home-brief-status"><span>CURRENT STATUS / 当前阶段</span><p>当前处于前期筹备阶段，非营利法人尚未完成注册，首届董事会尚未依法产生。</p></div>
  </div>
...
<section class="home-brief-section" id="political-capacity">
  ...
  <div class="home-brief-capacity-grid"><article><span>01</span><h3>信任</h3><strong>组织间政治信任</strong><p>建立可以被识别、沟通并逐渐形成信任的组织主体。</p></article><article><span>02</span><h3>能力</h3><strong>组织基础设施</strong><p>建立法律、财务、人员、治理、档案与责任体系。</p></article><article><span>03</span><h3>人才</h3><strong>公共治理人才</strong><p>识别、培养并检验能够承担公共责任的人。</p></article></div>
  <p class="home-brief-formula">信任 <span>×</span> 能力 <span>×</span> 人才 <span>=</span> 政治承接能力</p>
</section>
...
<section class="home-brief-section home-brief-board" id="why-board">
  ...
  <p>董事会意味着公民秩序主义第一次把政治承诺转化为组织规则，使治理、监督、财务责任、风险管理与组织连续性不再依赖个人意志。</p>
  <div class="home-brief-section__footer"><strong>董事会不是形式要求，而是组织开始接受约束的制度起点。</strong><a href="/preparation/board">了解首届董事会筹备</a></div>
</section>
...
<section class="home-brief-section" id="organization-boundaries">
  ...
  <div class="home-brief-boundaries"><div><h3>不是</h3><ol><li>革命组织</li><li>政治清算平台</li><li>地下政治组织</li><li>个人政治工具</li></ol></div><div><h3>希望成为</h3><ol><li>公开</li><li>合法</li><li>长期</li><li>制度化</li><li>具有公共责任</li><li>具有政治信誉</li></ol></div></div>
...
<section class="home-brief-section" id="long-term-cooperation">
  ...
  <ol class="home-brief-principles"><li><span>01</span>和平政治转轨</li><li><span>02</span>不革命、不清算</li><li><span>03</span>保持国家行政连续性</li><li><span>04</span>程序优先于个人意志</li></ol>
  <p class="home-brief-principles-note">同时要求权力接受制度约束、组织逐渐摆脱个人化，并能够与不同意见长期合作。</p>
...
<section class="home-brief-section" id="development-path">
  ...
  <div class="home-brief-path"><section class="home-brief-path__group home-brief-path__group--complete"><p>已经完成</p><ol><li><span>01</span><strong>理论形成</strong></li><li><span>02</span><strong>公共传播</strong></li></ol></section><section class="home-brief-path__group home-brief-path__group--current"><p>CURRENT STAGE / 当前阶段</p><ol><li><span>03</span><strong>组织建设</strong></li><li><span>04</span><strong>非营利法人</strong></li><li><span>05</span><strong>首届董事会</strong></li></ol></section><section class="home-brief-path__group home-brief-path__group--future"><p>长期目标</p><ol><li><span>06</span><strong>组织信用</strong></li><li><span>07</span><strong>长期政治承接能力</strong></li></ol></section></div>
</section>

<section class="home-brief-section home-brief-document" id="official-document">
  <div class="home-brief-document__content"><p class="home-brief-eyebrow">OFFICIAL DOCUMENT · CO-2026-002</p><h2>公民秩序主义<br>北美非营利组织及首届董事会筹备文件</h2><p class="home-brief-document__version">Version 1.0 · 2026</p><p>本文件完整说明组织建设、政治承接能力、首届董事会与当前发展路径。</p><a class="home-brief-button home-brief-button--document" href="/files/civic-orderism-founding-board-brief-2026.pdf" target="_blank" rel="noopener">打开正式文件</a></div>
  <div class="home-brief-document__cover"><img src="/files/civic-orderism-founding-board-brief-2026-cover.png" alt="《公民秩序主义北美非营利组织及首届董事会筹备文件》封面" width="1191" height="1684" loading="lazy"></div>
</section>

<section class="home-brief-section" id="theory-and-research">
  <div class="home-brief-section__heading"><p class="home-brief-eyebrow">07 · THEORY & RESEARCH</p><h2>理论与研究</h2><p>这套组织建设建立在持续的政治判断、现实分析与中国未来研究基础之上。</p></div>
...
<section class="home-brief-section home-brief-foundation" id="introduction-manual-entry">
  <a href="/introduction-manual">第一次了解公民秩序主义？阅读《公民秩序主义介绍手册》 →</a>
</section>

<section class="home-brief-section home-brief-contact" id="contact">
  <div><p class="home-brief-eyebrow">CONTACT</p><h2>建立联系</h2><p>围绕首届董事会筹备、专业合作与长期组织建设建立联系。</p></div>
