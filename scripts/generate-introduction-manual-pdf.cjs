...
${referenceStyle}
    ...
    .cover-meta { grid-template-columns: 1fr; gap: 2.2mm; font-size: 9.2pt; }
...
<body>
  ...
  <section class="cover">
    ...
    <div class="cover-meta">
      <div><strong>citizenorder@proton.me</strong></div>
      <div><strong>x.com/CivicOrderism</strong></div>
      <div><strong>civicorderism.com</strong></div>
    </div>
  </section>
  ...
  <section class="chapter contact-chapter">
    ...
    <div class="contact-section">
      ...
      <div class="contact-lines">
        <span>邮箱</span><strong><a href="mailto:citizenorder@proton.me">citizenorder@proton.me</a></strong>
        <span>X 平台</span><strong><a href="https://x.com/CivicOrderism">@CivicOrderism</a></strong>
        <span>网站</span><strong><a href="https://civicorderism.com">civicorderism.com</a></strong>
      </div>
    </div>
  </section>
  ...
  <section class="back-cover">
    ...
    <div class="back-contact">
      citizenorder@proton.me<br>
      x.com/CivicOrderism<br>
      civicorderism.com
    </div>
  ...
  await page.pdf({
    ...
    footerTemplate: `
      <div style="width:100%;padding:0 18mm;font-family:Arial,sans-serif;font-size:7px;color:#6b7582;display:flex;justify-content:space-between;letter-spacing:.05em;">
        <span>civicorderism.com</span><span><span class="pageNumber"></span> / <span class="totalPages"></span></span>
      </div>`,
  });
  await browser.close();
