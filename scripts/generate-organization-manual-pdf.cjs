...
const HTML_PATH = path.join(ROOT, "quartz", "static", "files", "civic-orderism-organization-manual.html")
const PDF_PATH = path.join(ROOT, "quartz", "static", "files", "civic-orderism-organization-manual.pdf")
const NODE_MODULES =
