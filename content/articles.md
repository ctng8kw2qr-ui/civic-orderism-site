...
<section class="reading-route reading-route--primary" id="route-first-visit" aria-labelledby="route-first-visit-title">
  <div class="reading-route__heading"><span class="reading-route__number">01</span><div><p class="resource-label">优先入口</p><h2 id="route-first-visit-title">第一次了解公民秩序主义</h2><p>用少量核心材料理解公民秩序主义是什么、为什么提出这条路线、试图解决什么问题，以及当前已经进入什么组织阶段。</p><dl class="reading-route__meta"><div><dt>适合</dt><dd>第一次访问本站，希望快速建立整体认识的读者</dd></div><div><dt>预计阅读时间</dt><dd>约 25–35 分钟</dd></div></dl></div></div>
  <div class="reading-route__body"><div class="reading-route__label"><span>推荐阅读</span><span>4 篇</span></div><ol class="reading-route__list"><li><span>01</span><a href="/introduction-manual">公民秩序主义介绍手册</a></li><li><span>02</span><a href="/civic-orderism/what-civic-orderism-solves-if-you-read-only-one">如果你只读一篇：公民秩序主义到底想解决什么</a></li><li><span>03</span><a href="/civic-orderism/why-civic-orderism">为什么是公民秩序主义？</a></li><li><span>04</span><a href="/civic-orderism/possibility-of-peaceful-political-transition-in-china">中国和平政治转型的可能性</a></li></ol><a class="reading-route__more" href="/civic-orderism">查看本路线延伸阅读 →</a><footer class="reading-route__completion"><p>完成这条路线后</p><a href="#route-china-reality">继续：理解今天的中国 →</a><div class="reading-route__organization"><p>已经理解基本路线？</p><div><a href="/preparation">了解董事会筹备<span aria-hidden="true"> →</span></a><a href="/participate">了解参与方式<span aria-hidden="true"> →</span></a></div></div></footer></div>
</section>

<section class="reading-route" id="route-china-reality" aria-labelledby="route-china-reality-title">
  <div class="reading-route__heading"><span class="reading-route__number">02</span><div><p class="resource-label">现实判断</p><h2 id="route-china-reality-title">理解今天的中国</h2><p>从中共的组织结构、官僚系统、路线调整与安全叙事出发，理解中国当前正在进入什么阶段，以及为什么现有治理逻辑越来越难以处理结构性问题。</p><dl class="reading-route__meta"><div><dt>适合</dt><dd>希望从中共组织运行与中国现实问题进入的读者</dd></div><div><dt>预计阅读时间</dt><dd>约 35–50 分钟</dd></div></dl></div></div>
  <div class="reading-route__body"><div class="reading-route__label"><span>推荐阅读</span><span>5 篇</span></div><ol class="reading-route__list"><li><span>01</span><a href="/china/ccp-no-real-base">中共最大的秘密：它根本没有基本盘</a></li><li><span>02</span><a href="/theory/party-state-structural-failure">党国系统的结构性失效：一个组织诊断</a></li><li><span>03</span><a href="/china/route-transition-why-ccp-keeps-purging-officials">路线转换：中共为什么必须不断清洗自己的官员</a></li><li><span>04</span><a href="/china/what-happens-when-security-becomes-the-top-priority">中共全面进入安全叙事后，中国会怎么样？</a></li><li><span>05</span><a href="/civic-orderism/possibility-of-peaceful-political-transition-in-china">中国和平政治转型的可能性</a></li></ol><a class="reading-route__more" href="/china">查看本路线延伸阅读 →</a><footer class="reading-route__completion"><p>完成这条路线后</p><a href="#route-theory">继续：理解公民秩序主义的理论路线 →</a></footer></div>
</section>

<section class="reading-route" id="route-theory" aria-labelledby="route-theory-title">
  <div class="reading-route__heading"><span class="reading-route__number">03</span><div><p class="resource-label">理论路线</p><h2 id="route-theory-title">理解公民秩序主义的理论路线</h2><p>从工业时代政治制度与信息化社会之间的错位进入，理解为什么需要新的政治组织方式，以及秩序、责任、专业判断和制度承接如何形成一条完整路线。</p><dl class="reading-route__meta"><div><dt>适合</dt><dd>希望理解公民秩序主义完整理论逻辑的读者</dd></div><div><dt>预计阅读时间</dt><dd>约 45–60 分钟</dd></div></dl></div></div>
  <div class="reading-route__body"><div class="reading-route__label"><span>推荐阅读</span><span>5 篇</span></div><ol class="reading-route__list"><li><span>01</span><a href="/civic-orderism/information-age-and-political-transition">信息化时代与政治转型</a></li><li><span>02</span><a href="/theory/end-of-party-politics-in-information-age">政党的历史终结：信息化时代为什么不再需要政党垄断政治入口</a></li><li><span>03</span><a href="/civic-orderism/state-must-rely-on-systems-not-drivers">国家不能只靠驾驶员：为什么现代治理必须依赖系统</a></li><li><span>04</span><a href="/civic-orderism/why-weaken-party-politics">公民秩序主义为什么刻意弱化政党政治</a></li><li><span>05</span><a href="/civic-orderism/why-civic-orderism">为什么是公民秩序主义？</a></li></ol><a class="reading-route__more" href="/theory">查看本路线延伸阅读 →</a><footer class="reading-route__completion"><p>完成这条路线后</p><a href="#route-institution-research">进入：进阶制度研究 →</a></footer></div>
</section>

<section class="reading-route reading-route--advanced" id="route-institution-research" aria-labelledby="route-institution-research-title">
  <div class="reading-route__heading"><span class="reading-route__number">04</span><div><p class="resource-label">进阶阅读</p><h2 id="route-institution-research-title">进阶制度研究</h2><p>适合已经了解公民秩序主义基本路线，希望进一步阅读委员会、选举、司法、行政执行、监督机制与后台系统的读者。</p><dl class="reading-route__meta"><div><dt>适合</dt><dd>已经完成基础阅读、希望深入制度研究的读者</dd></div><div><dt>预计阅读时间</dt><dd>约 60–120 分钟</dd></div></dl></div></div>
  <div class="reading-route__body"><div class="reading-route__label"><span>推荐阅读</span><span>5 篇</span></div><ol class="reading-route__list"><li><span>01</span><a href="/civic-orderism/what-is-committee-system">什么是委员会：公民秩序主义中的委员会体系、工作流程与制度架构</a></li><li><span>02</span><a href="/civic-orderism/election-logic-under-civic-orderism">公民秩序主义下的选举逻辑：它与传统选举的区别，以及制度优势</a></li><li><span>03</span><a href="/civic-orderism/backend-system-under-civic-orderism">公民秩序主义对后台系统的重视</a></li><li><span>04</span><a href="/civic-orderism/why-justice-serves-reality">为什么公民秩序主义强调司法是为现实服务的</a></li><li><span>05</span><a href="/civic-orderism/state-operation-process-under-civic-orderism">公民秩序主义下国家运行的大概流程</a></li></ol><a class="reading-route__more" href="/civic-orderism">查看本路线延伸阅读 →</a><footer class="reading-route__completion"><p>完成这条路线后</p><a href="#all-articles">浏览全部文章 →</a></footer></div>
</section>
...
<p class="reading-map-section-note">先理解工业时代制度为什么在信息化社会里失去统合能力。</p>
...
<p class="reading-map-section-note">这一组文章用于理解中共不是单点危机，而是组织信用、责任结构和激励机制同步失效。</p>
...
<p class="reading-map-section-note">从经济、财政、社会心理和官僚行为观察中国现实正在进入的阶段。</p>
...
<p class="reading-map-section-note">这一组用于校正外部观察中常见的主体误判、战争误判和历史类比误判。</p>
...
<p class="reading-map-section-note">从“为什么旧通道不够”进入“为什么需要可解释、可纠错、可追责的新通道”。</p>
...
<p class="reading-map-section-note">这一组是公民秩序主义的理论骨架：国家如何从人格依赖转向系统依赖。</p>
...
<p class="reading-map-section-note">理解委员会不是替代行政做事，而是建立公共判断、纠偏和责任识别机制。</p>
...
<p class="reading-map-section-note">这一组说明选举如何回到授权、责任和代表关系，而不是沦为资本、动员和表演。</p>
...
<p class="reading-map-section-note">这里进入制度运行的底层条件：留痕、培训、司法、执行和信息透明。</p>
...
<p class="reading-map-count">本站共收录 97 篇文章。四条路线提供阅读起点，完整索引继续保留所有现有入口。</p>
