...
<p class="reading-map-section-note">先理解工业时代制度为什么在信息化社会里失去统合能力。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">这一组文章用于理解中共不是单点危机，而是组织信用、责任结构和激励机制同步失效。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">从经济、财政、社会心理和官僚行为观察中国现实正在进入的阶段。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">这一组用于校正外部观察中常见的主体误判、战争误判和历史类比误判。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">从“为什么旧通道不够”进入“为什么需要可解释、可纠错、可追责的新通道”。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">这一组是公民秩序主义的理论骨架：国家如何从人格依赖转向系统依赖。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">理解委员会不是替代行政做事，而是建立公共判断、纠偏和责任识别机制。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">这一组说明选举如何回到授权、责任和代表关系，而不是沦为资本、动员和表演。<span>推荐先读</span></p>
...
<p class="reading-map-section-note">这里进入制度运行的底层条件：留痕、培训、司法、执行和信息透明。<span>推荐先读</span></p>
