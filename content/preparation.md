...
<section class="inst4l-section">
  <div class="inst4l-section__head">
<p class="inst4-eyebrow">为什么需要法人</p>
<h2 class="inst4l-section__title">让公共事业不依赖个人</h2>
...
<section class="inst4l-section">
  <div class="inst4l-section__head">
<p class="inst4-eyebrow">为什么需要董事会</p>
<h2 class="inst4l-section__title">让方向与责任受到明确监督</h2>
<p class="inst4l-section__desc">治理责任，不是荣誉头衔。</p>
  </div>
...
<ul class="inst4l-checklist"><li><strong>守护公共使命</strong><span>确保研究、出版与组织工作持续服务于长期公共目的。</span></li><li><strong>承担法定责任</strong><span>依照最终注册法域的法律要求，对重大决策、合规与监督承担责任。</span></li><li><strong>保护组织资产</strong><span>监督财务、知识产权、域名、网站、账号、档案和其他公共资产。</span></li></ul>
  ...
  <section class="inst4l-section">
  <div class="inst4l-section__head">
<p class="inst4-eyebrow">当前工作</p>
<h2 class="inst4l-section__title">先建立规则，再扩大参与</h2>
<p class="inst4l-section__desc">当前处于前期筹备、沟通与框架建设阶段。</p>
  </div>
...
<p><strong>参与筹备不自动产生董事身份或治理权限。</strong>董事、法定成员、官方代表及其他正式治理职务，均须在制度准备完成后，依照适用法律、章程与正式程序产生。</p>
  ...
  <section class="inst4l-section">
  <div class="inst4l-section__head">
<p class="inst4-eyebrow">正式筹备文件</p>
<h2 class="inst4l-section__title">正式文件</h2>
    
  </div>
  <div class="inst4l-doc">
  ...
  <section class="inst4l-section">
  <div class="inst4l-section__head">
<p class="inst4-eyebrow">建立联系</p>
<h2 class="inst4l-section__title">进一步了解或建立联系</h2>
<p class="inst4l-section__desc">当前正在识别潜在首届董事候选人，并建立专业协作联系。</p>
  </div>
