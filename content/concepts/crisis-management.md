...
date: 2026-07-19
updated: 2026-07-20
description: "组织在风险中优先维持可控性、责任边界与行动连续性的机制。"
contentType: "核心概念"
status: published
listed: false
folderListed: false
...
<p class="concept-definition">组织在风险中优先维持可控性、责任边界与行动连续性的机制。</p>
...
方向重要，但现有说明尚未清楚区分危机处置、风险治理与危机机制常态化。

## 形成机制

短期处置逻辑持续化后，会重塑正常治理的激励结构。
...
<article class="knowledge-card" data-knowledge-card data-topics="xi-era" data-concepts="security-purge-recentralization-cycle political-control-governance-divergence security-recentralization party-state-stress bureaucratic-shock crisis-management">
...
- [[concepts/ruling-techniques|统治术]]
